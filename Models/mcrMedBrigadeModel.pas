...
uses
  System.SysUtils, System.Classes, System.JSON, System.IOUtils, Vcl.Graphics,
...
const
  BrigadeStatusStrings: array[TBrigadeStatus] of string = ('Свободна', 'Подтверждение вызова', 'Прибыла', 'В работе', 'Без связи');
