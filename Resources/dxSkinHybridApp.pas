...
initialization
  dxUnitsLoader.AddUnit(SysInit.HInstance, 'dxSkinHybridApp', RegisterPainters, UnregisterPainters);
finalization
  dxUnitsLoader.RemoveUnit(SysInit.HInstance, 'dxSkinHybridApp', UnregisterPainters);
{$ENDIF}
end.
